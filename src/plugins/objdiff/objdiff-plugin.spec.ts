...
describe('ObjdiffPlugin', () => {
  ...
  `;
        const compiledResult = await compiler.compile('ActualFunc', cCode, emptyContextPath, DEFAULT_ARM_FLAGS);
        const targetResult = await compiler.compile('ActualFunc_copy', cCode, emptyContextPath, DEFAULT_ARM_FLAGS);
